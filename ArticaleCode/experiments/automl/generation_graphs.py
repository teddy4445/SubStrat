...
class GenerationGraph:
    ...
    def run_absolute():
        ...
        df = pd.read_csv(r"C:\Users\lazeb\Desktop\stability_feature_selection_dataset_summary\experiments\automl\dataset_17_generation_analysis.csv")
        fig, ax1 = plt.subplots()

        ax1.set_xlabel('Genetic algorithm generation')
        ax1.set_ylabel('Absolute time save',
                       color="blue")
        ...
        color = 'orange'
        ax2.set_ylabel('Absolute accuracy reduce',
        ...
        plt.savefig("dataset_17_generation_graph_absolute.png")
        plt.close()
    ...
    def run_relative():
        ...
        ax1.set_xlabel('Genetic algorithm generation')
        ax1.set_ylabel('Relative time save',
                       color="blue")
        ax1.plot(df["generation"],
        ...
        color = 'orange'
        ax2.set_ylabel('Relative accuracy reduce',
                       color=color)  # we already handled the x-label with ax1
        ax2.plot(df["generation"],
                 df["avg_relative_acc"],
                 "--P",
        ...
        fig.tight_layout()  # otherwise the right y-label is slightly clipped
        plt.savefig("dataset_17_generation_graph_relative.png")
        plt.close()
